...
:: Android packaging
set AND_CERT_NAME="Save the Village"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\SavetheVillage.p12
...
set IOS_PROVISION=cert\SavetheVillage.mobileprovision
...
set APP_ID=air.SavetheVillage

:: Output packages
set DIST_PATH=dist
set DIST_NAME=SavetheVillage
